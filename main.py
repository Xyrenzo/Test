...
posts = {
    "en": {"title": "Hello World!", "body": "This is the first post.", "img": "/static/img/post.jpg"},
    "ru": {"title": "Привет, мир!", "body": "Это первый пост.", "img": "/static/img/post.jpg"},
    "ja": {"title": "こんにちは世界！", "body": "これは最初の投稿です。", "img": "/static/img/post.jpg"},
    "ko": {"title": "안녕하세요 세계!", "body": "이것은 첫 번째 게시물입니다.", "img": "/static/img/post.jpg"},
    "zh": {"title": "你好，世界！", "body": "这是第一篇帖子。", "img": "/static/img/post.jpg"},
    "es": {"title": "¡Hola Mundo!", "body": "Esta es la primera publicación.", "img": "/static/img/post.jpg"},
    "pt": {"title": "Olá Mundo!", "body": "Este é o primeiro post.", "img": "/static/img/post.jpg"},
}
